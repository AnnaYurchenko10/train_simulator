...
def traffic(trains, queue_trains, terminal_name, terminal_point):
    for train in trains:
        ...
        elif (train.status == Train_Status.TRANSIT_IN_TERMINAL.value) and (train.distance_traveled <= 0):
            train.status = Train_Status.WAIT.value
...
for i in Arrow.range('hours', start_time, end_time):
    ...
    # if (raduzniy_train.cargo == raduzniy_train.capacity) and (raduzniy_train.distance_traveled != 0):
    #     print("{}, {}, {}, {}, {}".format(start_time, raduzniy.oil, raduzniy.production, None, None))
    # else:
    #     print("{}, {}, {}, {}, {}, {}, {}".format(start_time, raduzniy.oil, raduzniy.production, raduzniy_train.name, raduzniy_train.cargo, raduzniy_train.status, raduzniy_train.current_coordinates))
